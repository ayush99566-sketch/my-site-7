...
$w.onReady(function () {
    ...
    function initializeSmartPreInitialization() {
        console.log('🚀 Initializing Smart Pre-Initialization System for Home Page...');
        ...
        console.log('✅ Smart Pre-Initialization System initialized for Home Page');
    }
    
    // Apply immediate post-refresh optimization
    function applyImmediatePostRefreshOptimization() {
        console.log('⚡ Applying immediate post-refresh optimization for Home Page...');
        ...
        try {
            ...
            console.log('✅ Immediate post-refresh optimization applied for Home Page');
            
        } catch (error) {
            console.warn('Immediate post-refresh optimization failed for Home Page:', error);
        }
    }
    
    // Enable progressive features
    function enableProgressiveFeatures() {
        console.log('🎯 Enabling progressive features for Home Page...');
        ...
        try {
            ...
            console.log('✅ Progressive features enabled for Home Page');
            
        } catch (error) {
            console.warn('Progressive features failed for Home Page:', error);
        }
    }
    
    // Enable full optimizations
    function enableFullOptimizations() {
        console.log('🚀 Enabling full optimizations for Home Page...');
        ...
        try {
            ...
            console.log('✅ Full optimizations enabled for Home Page');
            
        } catch (error) {
            console.warn('Full optimizations failed for Home Page:', error);
        }
    }
    
    // Optimize 03 Balloon to Trybs transition specifically
    function optimize03ToTrybsTransition() {
        console.log('🎈🎯 Optimizing 03 Balloon to Trybs transition for Home Page...');
        ...
        try {
            ...
            console.log('✅ 03 Balloon to Trybs transition optimized for Home Page');
            
        } catch (error) {
            console.warn('03 Balloon to Trybs optimization failed for Home Page:', error);
        }
    }
    
    // NEW: GRADIENT & VIDEO OPTIMIZATION SYSTEM
    function initializeGradientAndVideoOptimizer() {
        console.log('🎨🎬 Initializing Gradient & Video Optimization System for Home Page...');
        ...
        console.log('✅ Gradient & Video Optimization System initialized for Home Page');
    }
    
    // Optimize gradients immediately
    function optimizeGradientsImmediately() {
        console.log('🎨 Optimizing gradients immediately for Home Page...');
                ...
                if (elements && elements.length > 0) {
                    elements.forEach(element => {
                        if (element && element.style) {
                            ...
                            console.log(`🎨 Optimized gradient element for Home Page: ${selector}`);
                        }
                    });
                }
            });
            
            console.log('✅ Gradients optimized for immediate performance on Home Page');
            
        } catch (error) {
            console.warn('Gradient optimization failed for Home Page:', error);
        }
    }
    
    // Optimize videos progressively
    function optimizeVideosProgressive() {
        console.log('🎬 Optimizing videos progressively for Home Page...');
        ...
        try {
            ...
            console.log('✅ Videos optimized for progressive loading on Home Page');
            
        } catch (error) {
            console.warn('Video optimization failed for Home Page:', error);
        }
    }
    ...
    function replaceVideoWithPlaceholder(element) {
        try {
            ...
            console.warn('Video placeholder creation failed for Home Page:', error);
        }
    }
    ...
    function loadVideoProgressive(placeholder) {
        try {
            ...
            if (newVideo.tagName === 'VIDEO') {
                ...
                // Add error handling
                newVideo.onError = () => {
                    console.warn('Video failed to load for Home Page, keeping placeholder');
                };
            }
            ...
            console.warn('Progressive video loading failed for Home Page:', error);
        }
    }
    
    // Enable progressive gradients
    function enableProgressiveGradients() {
        console.log('🎨 Enabling progressive gradients for Home Page...');
                ...
                gradientElements.forEach((element, index) => {
                    if (element && element.dataset.originalGradient) {
                        setTimeout(() => {
                            ...
                            console.log(`🎨 Restored gradient element ${index + 1} for Home Page`);
                        }, index * 100); // 100ms delay between each gradient
                    }
                });
            }
            
            console.log('✅ Progressive gradients enabled for Home Page');
            
        } catch (error) {
            console.warn('Progressive gradient enabling failed for Home Page:', error);
        }
    }
    
    // Enable full video loading
    function enableFullVideoLoading() {
        console.log('🎬 Enabling full video loading for Home Page...');
        ...
        try {
            ...
            console.log('✅ Full video loading enabled for Home Page');
            
        } catch (error) {
            console.warn('Full video loading failed for Home Page:', error);
        }
    }
