// Progressive Enhancement - Non-blocking initialization
(function() {
    // Prevent blocking during initial load
    ...
    // Expose safe initialization
    window.safeInit = safeInit;
    window.queueInit = queueInit;
})();
...
// Progressive Enhancement - Initialize when ready
queueInit(function() {
    $w.onReady(function () {
